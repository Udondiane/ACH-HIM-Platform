...
export default function PartnerErrorBoundary({
  ...
  useEffect(() => {
    ...
    console.error('[partner] route error caught by group error.tsx', error);
  }, [error]);

  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-4">
        <div className="text-[10.5px] uppercase tracking-[1.2px] text-ach-navy/55">Partner portal</div>
        ...
        <div className="flex items-start gap-2.5">
          ...
          <div className="space-y-2 text-[13px] text-ach-navy/80">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <Link href="/partner-dashboard" className="text-[12.5px] text-ach-navy underline">
                ← Back to dashboard
              </Link>
            </div>
          </div>
