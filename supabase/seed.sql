...
values
  ('22222222-2222-2222-2222-000000000001', 'BRI-2026-Q3', 'Bridge to Employment — Bristol Q3 2026', 'multi_partner', 'in_progress', 'Bristol', 'Hospitality + Retail + Construction support', '2026-07-15', '2026-10-07', 12, 11, 17570.00, 'Memo §9 realistic-cohort exemplar (11 starts, 2 CI + 9 WP, mid-conversion).')
on conflict (id) do nothing;

insert into public.cohort_partners (cohort_id, partner_id, sponsorship_count, engagement_fee, is_lead_partner)
values
  ('22222222-2222-2222-2222-000000000001', '11111111-1111-1111-1111-000000000001', 3, 6510.00, false),  -- Burges Salmon 3 × £2,170
  ('22222222-2222-2222-2222-000000000001', '11111111-1111-1111-1111-000000000004', 5, 10850.00,false),  -- B&K 5 × £2,170
...
values
  ('44444444-4444-4444-4444-000000000001', 'PRJ-2026-B2E-Q3', 'Bridge to Employment — Q3 cohort', 'Memo §A — 12-week B2E programme.', '22222222-2222-2222-2222-000000000001', 'depth', 'd3_1', 'A', '2026-07-15', '2026-10-07', 'active')
on conflict (id) do nothing;
...
-- ── PLACEMENTS (selected — Pret has 3 hires per memo §8 example) ─
