...
export default function CohortsErrorBoundary({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    ...
    console.error('[cohorts] route error caught by error.tsx', error);
  }, [error]);
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-4">
        ...
        <h1 className="text-[22px] font-medium text-ach-navy">Something went wrong on this cohort page</h1>
      </div>
        ...
        <div className="flex items-start gap-2.5">
          ...
          <div className="space-y-2 text-[13px] text-ach-navy/80">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <Link href="/cohorts" className="text-[12.5px] text-ach-navy underline">
                ← Back to cohorts
              </Link>
            </div>
          </div>
