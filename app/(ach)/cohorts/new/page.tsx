  ...
  return (
    <div className="max-w-3xl mx-auto">
      <PageHeader
        ...
        miniLabel="Network"
        title="New cohort"
        description="Once the cohort is created, you'll be able to link partners (sponsorships, partner investment or grant amounts) and candidates from the cohort's detail page."
      />
      <Card>
